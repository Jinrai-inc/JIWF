 ...
 * Repeat the inner block for each partner type.
 */
return <<<'HTML'
...
<p class="has-text-align-center eyebrow has-gold-color has-text-color has-xs-font-size" style="font-weight:500;letter-spacing:0.25em;text-transform:uppercase">Founding Partners</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"center","className":"eyebrow","fontSize":"xs","style":{"typography":{"letterSpacing":"0.25em","textTransform":"uppercase","fontWeight":"500"}},"textColor":"gold"} -->
<p class="has-text-align-center eyebrow has-gold-color has-text-color has-xs-font-size" style="font-weight:500;letter-spacing:0.25em;text-transform:uppercase">Educational Partners</p>
<!-- /wp:paragraph -->

<!-- wp:html -->
<div class="partner-row">
	<span class="partner-row__city"><em>Add partner logos here</em></span>
</div>
<!-- /wp:html -->
