<?php
/**
 * About page — full starter layout (Japanese base).
 */
return <<<'HTML'
...
<!-- wp:heading {"textAlign":"center","level":1,"fontFamily":"jp-serif","fontSize":"4xl","style":{"typography":{"fontWeight":"500"}}} --><h1 class="wp-block-heading has-text-align-center has-jp-serif-font-family has-4xl-font-size" style="font-weight:500">新しい文明のための、新しい教育</h1><!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","fontSize":"lg","textColor":"text-muted"} --><p class="has-text-align-center has-text-muted-color has-text-color has-lg-font-size">JIWF Academy は、単なる教育機関ではありません。21世紀そして22世紀に向けて、リーダーシップ・教育・人間の可能性を再定義する挑戦です。</p><!-- /wp:paragraph -->
</section>
<!-- /wp:group -->
...
<!-- wp:paragraph {"align":"center","fontFamily":"jp-serif","fontSize":"2xl","style":{"typography":{"fontWeight":"500","lineHeight":"2"}},"textColor":"navy"} --><p class="has-text-align-center has-navy-color has-text-color has-jp-serif-font-family has-2xl-font-size" style="font-weight:500;line-height:2">バガヴァッド・ギーターの智慧、ホリスティックなウェルビーイング、変革を生むリーダーシップ教育を通じて、女性が自らの使命を見出し、内なる力を育み、世界に価値ある変化を生み出すことを支援します。</p><!-- /wp:paragraph -->
<!-- wp:html --><div class="jiwf-divider" aria-hidden="true"><span class="jiwf-divider__line"></span><span class="jiwf-divider__symbol">✦</span><span class="jiwf-divider__line"></span></div><!-- /wp:html -->
</section>
<!-- /wp:group -->
